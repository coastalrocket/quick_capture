...
- defining a quick_capture_types table in the project. See https://app.qfield.cloud/a/andybmapman/quick_capture/ for example project - and load the buttons from the settings dialog
